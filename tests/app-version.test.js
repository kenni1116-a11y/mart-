...
test("release metadata exposes one display label for version 0.6.4 build 64", () => {
  assert.equal(MartRelease.version, "0.6.4");
  assert.equal(MartRelease.build, 64);
  assert.equal(MartRelease.label, "Version 0.6.4 · Build 64");
});
