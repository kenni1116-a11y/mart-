...
test("release metadata exposes one display label for version 0.7.7 build 77", () => {
  assert.equal(MartRelease.version, "0.7.7");
  assert.equal(MartRelease.build, 77);
  assert.equal(MartRelease.label, "Version 0.7.7 · Build 77");
});
