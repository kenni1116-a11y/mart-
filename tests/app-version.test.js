...
test("release metadata exposes one display label for version 0.7.4 build 74", () => {
  assert.equal(MartRelease.version, "0.7.4");
  assert.equal(MartRelease.build, 74);
  assert.equal(MartRelease.label, "Version 0.7.4 · Build 74");
});
