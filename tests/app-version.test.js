...
test("release metadata exposes one display label for version 0.6.6 build 66", () => {
  assert.equal(MartRelease.version, "0.6.6");
  assert.equal(MartRelease.build, 66);
  assert.equal(MartRelease.label, "Version 0.6.6 · Build 66");
});
