...
test("release metadata exposes one display label for version 0.7.0 build 70", () => {
  assert.equal(MartRelease.version, "0.7.0");
  assert.equal(MartRelease.build, 70);
  assert.equal(MartRelease.label, "Version 0.7.0 · Build 70");
});
