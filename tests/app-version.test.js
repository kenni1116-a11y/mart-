...
test("release metadata exposes one display label for version 0.6.7 build 67", () => {
  assert.equal(MartRelease.version, "0.6.7");
  assert.equal(MartRelease.build, 67);
  assert.equal(MartRelease.label, "Version 0.6.7 · Build 67");
});
