...
test("release metadata exposes one display label for version 0.7.8 build 78", () => {
  assert.equal(MartRelease.version, "0.7.8");
  assert.equal(MartRelease.build, 78);
  assert.equal(MartRelease.label, "Version 0.7.8 · Build 78");
});
