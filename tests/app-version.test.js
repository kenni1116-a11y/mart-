...
test("release metadata exposes one display label for version 0.6.5 build 65", () => {
  assert.equal(MartRelease.version, "0.6.5");
  assert.equal(MartRelease.build, 65);
  assert.equal(MartRelease.label, "Version 0.6.5 · Build 65");
});
