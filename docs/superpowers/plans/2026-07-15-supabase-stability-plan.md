...
- [x] **Step 1: Add a transactional SQL test for the live invariants**
...
- [x] **Step 2: Run the new test against production before the migration**
...
- [x] **Step 1: Add the owner-membership trigger and non-destructive backfill**
...
- [x] **Step 2: Drop only obsolete pre-v2 shared-list functions**
...
- [x] **Step 3: Add the local Supabase test runner**
...
- [x] **Step 4: Wire GitHub Actions to the local database**
...
- [x] **Step 5: Run local checks that do not require Docker**
...
- [x] **Step 1: Recheck live migration state, RLS, grants, Realtime publication, and relational integrity**

- [x] **Step 2: Run `pnpm verify`, syntax checks, and `git diff --check` locally**
